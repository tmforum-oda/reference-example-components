...
// Validates product.productSpecification.href against TMF620 (ProductCatalog).
// Skips validation if productSpecification or productSpecification.href is absent.
async function validateProductSpecHref(payload) {
  const href = payload?.productSpecification?.href;
  ...
  try {
    ...
    throw new TError(TErrorEnum.UNPROCESSABLE_ENTITY, `Could not resolve productSpecification.href: ${href}`);
  }
  return payload;
}

module.exports = { validateRequest, validateProductSpecHref };
