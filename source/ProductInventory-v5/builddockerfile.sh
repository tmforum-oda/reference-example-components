...
docker buildx build -t "akumartmf/productinventoryapi:0.2" --platform "linux/amd64,linux/arm64" -f productinventory-dockerfile . --push
...
docker buildx build -t "akumartmf/productinventorymcp:0.2" --platform "linux/amd64,linux/arm64" -f productinventory-mcp-dockerfile . --push
