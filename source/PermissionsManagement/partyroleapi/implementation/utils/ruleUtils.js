...
// Validates partyRole.engagedParty.href against TMF632.
// Skips validation if engagedParty or engagedParty.href is absent.
async function validateEngagedPartyHref(payload) {
  const href = payload?.engagedParty?.href;
  ...
  try {
    ...
    throw new TError(TErrorEnum.UNPROCESSABLE_ENTITY, `Could not resolve engagedParty.href: ${href}`);
  }
  return payload;
}

module.exports = { validateRequest, validateEngagedPartyHref };
