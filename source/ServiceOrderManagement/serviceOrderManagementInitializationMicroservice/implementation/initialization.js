...
const createMetricsEventListner = async () => {
  ...
  while (complete == false) {
    try {
        ...
        const url = 'http://' + releaseName + '-serviceorderapi:8080/' + componentName + '/tmf-api/serviceOrdering/v4/hub';
        console.log('POSTing listener with callback ', metricsEventListner, ' to: ', url);
