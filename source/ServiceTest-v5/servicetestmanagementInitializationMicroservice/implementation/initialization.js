...
const registerListeners = async () => {
  ...
  while (!complete) {
    try {
      ...
      // Register metrics listener on TMF653 Service Test Management hub
      const serviceTestHubUrl = 'http://' + releaseName + '-servicetestapi:8080/' + componentName + '/tmf-api/serviceTestManagement/v4/hub';
      console.log('POSTing listener to:', serviceTestHubUrl);
      await axios.post(serviceTestHubUrl, metricsEventListener, { timeout: 10000 });
