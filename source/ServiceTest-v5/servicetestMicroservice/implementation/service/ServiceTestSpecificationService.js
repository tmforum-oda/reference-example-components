  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        ...
        }).catch(error => { console.log("createServiceTestSpecification: error=" + error); sendError(res, internalError); });
...
exports.patchServiceTestSpecification = function(req, res, next) {
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => traverse(req, requestSchema, payload, [], getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('patchServiceTestSpecification', payload))
    .then(payload => {
      payload = swaggerUtils.updatePayloadServiceType(payload, req, '');
      mongoUtils.connect().then(db => {
        ...
        }).catch(error => { console.log("patchServiceTestSpecification: error=" + error); sendError(res, internalError); });
      }).catch(error => sendError(res, internalError));
    }).catch(error => sendError(res, error));
};
...
exports.deleteServiceTestSpecification = function(req, res, next) {
  ...
  mongoUtils.connect().then(db => {
    ...
    }).catch(error => { console.log("deleteServiceTestSpecification: error=" + error); sendError(res, internalError); });
  }).catch(error => sendError(res, internalError));
};
