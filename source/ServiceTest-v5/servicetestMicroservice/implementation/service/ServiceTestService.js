...
const {validateRequest, validateRelatedServiceHref} = require('../utils/ruleUtils');
...
exports.createServiceTest = function(req, res, next) {
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => validateRelatedServiceHref(payload))
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        ...
        }).catch(error => { console.log("createServiceTest: error=" + error); sendError(res, internalError); });
...
exports.patchServiceTest = function(req, res, next) {
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => traverse(req, requestSchema, payload, [], getPayloadType(req)))
    .then(payload => processCommonAttributes(req, resourceType, payload))
    .then(payload => processAssignmentRules('patchServiceTest', payload))
    .then(payload => {
      payload = swaggerUtils.updatePayloadServiceType(payload, req, '');
      mongoUtils.connect().then(db => {
        ...
        }).catch(error => { console.log("patchServiceTest: error=" + error); sendError(res, internalError); });
      }).catch(error => sendError(res, internalError));
    }).catch(error => sendError(res, error));
};
...
exports.deleteServiceTest = function(req, res, next) {
  ...
  mongoUtils.connect().then(db => {
    ...
    }).catch(error => { console.log("deleteServiceTest: error=" + error); sendError(res, internalError); });
  }).catch(error => sendError(res, internalError));
};
